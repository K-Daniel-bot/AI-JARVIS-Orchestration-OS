...
╚══════════════════════════════════════════╝${C.reset}
  ...
  ${C.green}●${C.reset} API 서버:   ${C.bold}http://localhost:3001${C.reset}
  ${C.blue}●${C.reset} 프론트엔드: ${C.bold}http://localhost:5173${C.reset}
  ${C.yellow}●${C.reset} Health:     ${C.bold}http://localhost:3001/health${C.reset}
...
async function main() {
  ...
  log("SERVER", C.green, "API 서버 시작 (port 3001)...");
